  ...
  return (
    <>
      ...
      <Sequence from={16} durationInFrames={58}>
        <Audio
          src={staticFile("narracao/Renovacao/01-titulo.mp3")}
          placeholder={undefined}
        />
      </Sequence>
      <Sequence from={110} durationInFrames={264}>
        <Audio
          src={staticFile("narracao/Renovacao/02-Intro.mp3")}
          placeholder={undefined}
        />
      </Sequence>
      <Sequence from={398} durationInFrames={205}>
        <Audio
          src={staticFile("narracao/Renovacao/03-acesso.mp3")}
          placeholder={undefined}
        />
      </Sequence>
      <Sequence from={410} durationInFrames={24}>
        <Audio
          src={staticFile("sons/ES_MouseClick.mp3")}
          placeholder={undefined}
        />
      </Sequence>
      <Sequence from={420} durationInFrames={72}>
        <Audio
          src={staticFile("sons/ES_KeyboardTyping.mp3")}
          placeholder={undefined}
        />
      </Sequence>
      ...
      <Sequence from={614} durationInFrames={154}>
        <Audio
          src={staticFile("narracao/Renovacao/04-menu.mp3")}
          placeholder={undefined}
        />
      </Sequence>
      ...
      <Sequence from={776} durationInFrames={240}>
        <Audio
          src={staticFile("narracao/Renovacao/05-credencial.mp3")}
          placeholder={undefined}
        />
      </Sequence>
      ...
      <Sequence from={1022} durationInFrames={144}>
        <Audio
          src={staticFile("narracao/Renovacao/06-vigencia.mp3")}
          placeholder={undefined}
        />
      </Sequence>
      <Sequence from={1178} durationInFrames={192}>
        <Audio
          src={staticFile("narracao/Renovacao/07-desconto.mp3")}
          placeholder={undefined}
        />
      </Sequence>
      ...
      <Sequence from={1388} durationInFrames={216}>
        <Audio
          src={staticFile("narracao/Renovacao/08-pagamento.mp3")}
          placeholder={undefined}
        />
      </Sequence>
      ...
      <Sequence from={1634} durationInFrames={168}>
        <Audio
          src={staticFile("narracao/Renovacao/09-sucesso.mp3")}
          placeholder={undefined}
        />
      </Sequence>
      ...
      <Sequence from={1814} durationInFrames={216}>
        <Audio
          src={staticFile("narracao/Renovacao/10-retentativa.mp3")}
          placeholder={undefined}
        />
      </Sequence>
      ...
      <Sequence from={2066} durationInFrames={264}>
        <Audio
          src={staticFile("narracao/Renovacao/11-fim.mp3")}
          placeholder={undefined}
        />
      </Sequence>
